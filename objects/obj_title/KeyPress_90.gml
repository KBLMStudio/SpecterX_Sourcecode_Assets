if ghost_alpha_0 = 1 && cursor_check = 1 {
		audio_play_sound(snd_select,1,0)
	title_check = 2 
	instance_create_depth(0,0,depth,obj_fade)
	obj_fade.rm_next = rm_0_mansion
}
if ghost_alpha_0 = 1 && cursor_check = 0 {
	if !file_exists("specterx_save.ini") {
		audio_play_sound(snd_nope,1,0)
	}
	else {
		//steve saves
		audio_play_sound(snd_select,1,0)
