if attack_end = 1 {
	...
	if image_xscale > 156/18 {
		image_xscale -= 1/9
	}
	if image_xscale < 156/18 {
		image_xscale += 1/9
	}
	if image_yscale > 34/18 {
		image_yscale -= 1/9
	}
	if image_yscale < 34/18 {
		image_yscale += 1/9
	}
		if point_distance(x,y,80,y) < 1 {
		x = 80
	}
	if x > 80 {
		x -= 1
...
if image_xscale= 156/18 && image_yscale = 34/18 && x = 80 {
	if !instance_exists(obj_bullet_parent_red) {
		if global.battle_enemy_health = 0 {
			obj_battle_device.battle_step = 4
...
text_y = 97
			if global.battle_enemy_health = 0 {
					...
					instance_create_depth(0,0,depth,obj_enemy_death)
						obj_battle_device.text_string[0] = global.battle_enemy_name + " was//defeated!"
	text_talking = 1
	if global.stev_array[5] < global.battle_enemy_exp {
	global.stev_array[4] += 20
	obj_battle_device.text_string[1] = "Steve gained 20 EXP!"
	}
	else {
		global.stev_array[4] += ceil(20/(global.kev_array[5]-global.battle_enemy_exp))
		obj_battle_device.text_string[1] = "Steve gained " + string(ceil(20/(global.kev_array[5]-global.battle_enemy_exp))) + " EXP!"
	}
	if global.stev_array[4] >= 100 {
		global.stev_array[4] -= 100
		if global.stev_array[5] != 99 {
		global.stev_array[5] += 1
		obj_battle_device.text_string[1] += "//...And they leveled up to LV " + string(global.kev_array[5]) + "!"
		if global.stev_array[5] = 3 || global.stev_array[5] = 12 || global.stev_array[5] = 21 || global.stev_array[5] = 30 || global.stev_array[5] = 39 || global.stev_array[5] = 48 || global.stev_array[5] = 57 || global.stev_array[5] = 66 || global.stev_array[5] = 75 || global.stev_array[5] = 84 || global.stev_array[5] = 93 {
			...
			obj_battle_device.text_string[1] += "//...And they gained 1 HP!"
		}
			...
			obj_battle_device.text_string[1] += "//...And they gained 1 attack point (AP:" + string(global.stev_array[2]) + ")!"
		}
			...
			obj_battle_device.text_string[1] += "//...And they gained 1 defense point (DP:" + string(global.stev_array[3]) + ")!"
			}
		}
	}
	if global.kev_array[5] < global.battle_enemy_exp {
	global.kev_array[4] += 20
	obj_battle_device.text_string[2] = "kevin gained 20 EXP!"
	}
	else {
		global.kev_array[4] += ceil(20/(global.kev_array[5]-global.battle_enemy_exp))
		obj_battle_device.text_string[2] = "kevin gained " + string(ceil(20/(global.kev_array[5]-global.battle_enemy_exp))) + " EXP!"
	}
	if global.kev_array[4] >= 100 {
		global.kev_array[4] -= 100
		if global.kev_array[5] != 99 {
		global.kev_array[5] += 1
		obj_battle_device.text_string[2] += "//...And they leveled up to LV " + string(global.kev_array[5]) + "!"
		if global.kev_array[5] = 3 || global.kev_array[5] = 12 || global.kev_array[5] = 21 || global.kev_array[5] = 30 || global.kev_array[5] = 39 || global.kev_array[5] = 48 || global.kev_array[5] = 57 || global.kev_array[5] = 66 || global.kev_array[5] = 75 || global.kev_array[5] = 84 || global.kev_array[5] = 93 {
			...
			obj_battle_device.text_string[2] += "//...And they gained 1 HP!"
		}
			...
			obj_battle_device.text_string[2] += "//...And they gained 1 attack point (AP:" + string(global.kev_array[2]) + ")!"
		}
			...
			obj_battle_device.text_string[2] += "//...And they gained 1 defense point (DP:" + string(global.kev_array[3]) + ")!"
			}
		}
	}
}
instance_destroy(self)
		...
		if global.stev_array[0] = 0 {
					obj_battle_device.battle_step = 2
				}
				else {
					obj_battle_device.battle_step = 1
				}
		instance_destroy(self)
			}
		}
