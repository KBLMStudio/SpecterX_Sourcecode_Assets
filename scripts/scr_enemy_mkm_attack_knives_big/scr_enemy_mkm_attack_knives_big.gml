...
function scr_enemy_mkm_attack_knives_big(){
if timer = 0 {
...
if red_check = 0 {
	instance_create_depth(checkx,checky,depth - 1,obj_bullet_knife_target_red)
	obj_bullet_knife_target_red.sprite_index = spr_bullet_knife_target_red
}
else {
instance_create_depth(checkx,checky,depth -1 ,obj_bullet_knife_target)
obj_bullet_knife_target.sprite_index = spr_bullet_knife_target
}
knives_timer = 0
knives_count += 1
}
